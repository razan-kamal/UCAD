...
<head>
  ...
  <title>@yield('title','UCAD ')</title>
  <meta content="" name="descriptison">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="{{url('frontSite/style')}}/assets/img/logo.png" rel="icon">
  <link href="{{url('frontSite/style')}}/assets/img/apple-touch-icon.png" rel="apple-touch-icon">
  ...
  <link href="{{url('frontSite/style')}}/assets/vendor/owl.carousel/assets/owl.carousel.min.css" rel="stylesheet">
  <link href="{{url('frontSite/style')}}/assets/vendor/aos/aos.css" rel="stylesheet">
  <link href="{{url('frontSite/style')}}/assets/vendor/remixicon/remixicon.css" rel="stylesheet">
